...
if [ $1 = zcu102 ]; then
      ...
      ARCH=/opt/vitis_ai/compiler/arch/DPUCAHX8H/U250/arch.json
      TARGET=u50
      echo "-----------------------------------------"
      echo "COMPILING MODEL FOR ALVEO U250.."
      echo "-----------------------------------------"
else
      echo  "Target not found. Valid choices are: zcu102, zcu104, vck190, u250 ..exiting"
      exit 1
fi
